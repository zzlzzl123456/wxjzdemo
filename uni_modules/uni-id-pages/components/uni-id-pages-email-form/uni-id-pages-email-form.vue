<template>
  <view>
    <uni-captcha :focus="focusCaptchaInput" ref="captcha" scene="register" v-model="captcha" />
    <view class="box">
      <uni-easyinput :focus="focusEmailCodeInput" @blur="focusEmailCodeInput = false" type="number" class="input-box"
        :inputBorder="false" v-model="modelValue" maxlength="6" placeholder="请输入邮箱验证码">
      </uni-easyinput>
