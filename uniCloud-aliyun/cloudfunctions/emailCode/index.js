...
exports.main = async (event, context) => {
	...
	var send = (data, code, codeString) => {
		var emailConfig = {
			...
			auth: {
				user: 'zzl1505358995@163.com',//此处填写要发送邮件的QQ邮箱
				pass: 'NCNNMWFHFSSZKZVP'//此处请自行生成并填写 //注意此处并不是QQ密码,而是QQ邮箱中成功开启POP3/SMTP服务,拿到的授权码,重要的事件说三遍,不是QQ密码,是QQ授权码!不是QQ密码,是QQ授权码!不是QQ密码,是QQ授权码!
				}
			}
		}
		// data为客户端上传的参数
